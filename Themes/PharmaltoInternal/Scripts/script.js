...
jQuery(function ($) {
    ...
    var header = $(".header");
    var bgimages = "url('images/object2125156932.png'), ".split(",");
    var bgpositions = "26px 26px, ".split(",");
...
jQuery(function() {
    ...
    jQuery("ul.vmenu, ul.hmenu").each(function() {
    ...
    jQuery("ul.vmenu ul:has(a.active), ul.hmenu ul:has(a.active)").each(function() {
        jQuery(this).addClass("active");
        jQuery(this).prev("a").addClass("active");
    });
    // add class "active" to LI that has active link
    jQuery("ul.vmenu li:has(a.active), ul.vmenu li:has(a.active)").addClass("active");
});

jQuery(function($) {
    "use strict";
    $('div.search>input[type="submit"]').attr('value', '');
});
