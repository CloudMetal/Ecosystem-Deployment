...
window.Modernizr = (function(window,document,undefined){
    ...
    tests['flexbox'] = function() {
         ...
         * @param  element
         * @param  property The property name. This will not be prefixed.
         * @param  value The value of the property. This WILL be prefixed.
         ...
         * @param  element
         * @param  property The property name. This WILL be prefixed.
         * @param  value The value of the property. This will not be prefixed.
         * @param {string=} extra Additional CSS to append unmodified to the end of
         * the CSS string.
         */
